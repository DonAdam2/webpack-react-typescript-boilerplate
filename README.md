...
- Use **envExtension** to set custom key in **build script**, .e.g `"build": "set envExtension=prod && webpack --mode=production  --config buildTools/webpack.prod.js --progress --color"`
...
- Use **envExtension** to set custom key in **build:staging script**, .e.g `"build:staging": "set envExtension=staging && webpack --mode=production  --config buildTools/webpack.prod.js --progress --color"`
